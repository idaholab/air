...
extern "C" void  __stdcall VU_HP_AIR_INI(double h, double p, double& v, double& u);
//
...
//
SBTLAPI int __stdcall PH_FLASH_AIR(double p, double h, double& v, double& vt, double& u) throw()
{
...
//
SBTLAPI void __stdcall PH_FLASH_DERIV_AIR(double p, double v, double vt, double u, double& dvdp_h, double& dvdh_p, double& dpdh_v, double& dudp_h, double& dudh_p, double& dpdh_u) throw()
{
