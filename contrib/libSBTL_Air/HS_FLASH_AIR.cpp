...
extern "C" void  __stdcall VU_SH_AIR_INI(double s, double h, double& vt, double& u);
//
...
extern "C" void __stdcall DIFF_S_VU_AIR_T(double vt, double v, double u, double& s, double& dsdv, double& dsdu, double& dudv);
extern "C" void __stdcall DIFF_S_VU_AIR_TT(double vt, double u, double& s, double& dsdv, double& dsdu, double& dudv);
extern "C" void __stdcall DIFF_P_VU_AIR_TT(double vt, double u, double& p, double& dpdv, double& dpdu, double& dudv);
//
SBTLAPI int __stdcall HS_FLASH_AIR(double h, double s, double& v, double& vt, double& u) throw()
{
    ...
    while(fabs(f_h)>df_h || fabs(f_s)>df_s) {
        ...
        DIFF_S_VU_AIR_TT(vt, u, sx, dsdv_u, dsdu_v, dudv_s);      // sx, transformed derivatives
        hx=u+px*v*1.e3;
...
//
SBTLAPI void __stdcall HS_FLASH_DERIV_AIR(double v, double vt, double u, double& dvdh_s, double& dvds_h, double& dhds_v, double& dudh_s, double& duds_h, double& dhds_u) throw()
{
    ...
    DIFF_S_VU_AIR_T(vt, v, u, s_, dsdv_u, dsdu_v, dudv_s);
...
//
SBTLAPI void __stdcall HS_PT_FLASH_DERIV_AIR(double v, double vt, double u, double& p, double& dpdh_s, double& dpds_h, double& dhds_p, double& t, double& dtdh_s, double& dtds_h, double& dhds_t) throw()
{
    double dhdv_u, dhdu_v;
    double dpdv_u, dpdu_v, dudv_p;
    ...
    //derivatives
    DIFF_P_VU_AIR_T(vt, v, u, p, dpdv_u, dpdu_v, dudv_p);
    DIFF_T_VU_AIR_T(vt, v, u, t, dtdv_u, dtdu_v, dudv_t);
    DIFF_S_VU_AIR_T(vt, v, u, s_, dsdv_u, dsdu_v, dudv_s);
