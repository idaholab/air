...
LIBSBTL_AIR_srcfiles  += $(LIBSBTL_AIR_DIR)/HS_FLASH_AIR.cpp
LIBSBTL_AIR_srcfiles  += $(LIBSBTL_AIR_DIR)/HV_FLASH_AIR.cpp
LIBSBTL_AIR_srcfiles  += $(LIBSBTL_AIR_DIR)/LAMBDA_VU_AIR.cpp
LIBSBTL_AIR_srcfiles  += $(LIBSBTL_AIR_DIR)/P_VU_AIR.cpp
LIBSBTL_AIR_srcfiles  += $(LIBSBTL_AIR_DIR)/PH_FLASH_AIR.cpp
LIBSBTL_AIR_srcfiles  += $(LIBSBTL_AIR_DIR)/PS_FLASH_AIR.cpp
LIBSBTL_AIR_srcfiles  += $(LIBSBTL_AIR_DIR)/PT_FLASH_AIR.cpp
